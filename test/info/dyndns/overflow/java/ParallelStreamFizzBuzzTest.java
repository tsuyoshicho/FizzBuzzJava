...
public class ParallelStreamFizzBuzzTest {
	@Test
	public void testResultCount() {
		int count = 10;
		FizzBuzz fb = FizzBuzzFactory.newParallelStreamFizzBuzz(count+1);
		assertEquals("count:" + count + " result:" + fb.result().size(),count ,fb.result().size());
	}

	@Test
	public void testMax100() {
		FizzBuzz fb = FizzBuzzFactory.newParallelStreamFizzBuzz(100);
		testFizzBuzz(fb);
	}

	@Test
	public void testMax50() {
		FizzBuzz fb = FizzBuzzFactory.newParallelStreamFizzBuzz(50);
		testFizzBuzz(fb);
	}

	@Test
	public void testMax1() {
		FizzBuzz fb = FizzBuzzFactory.newParallelStreamFizzBuzz(1);
		testFizzBuzz(fb);
	}
